...
import { Upload, Download, RefreshCw, Image as ImageIcon, HardDrive, Eye, X, CheckCircle, AlertTriangle } from "lucide-react";
...
export default function ImageCompressor() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-6 font-sans relative">
      ...
      <div className="max-w-5xl mx-auto mt-8 h-[250px] bg-white border border-gray-300 rounded-lg flex items-center justify-center text-gray-400 text-sm">
