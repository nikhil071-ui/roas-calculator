...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Complete Guide to Image Compression | Reduce Photos to 50KB - Technical & Practical Tips",
    description: "Expert guide to image compression. Learn JPEG vs PNG, compression algorithms, file sizes, and step-by-step instructions for government forms, exam portals, and web optimization.",
    url: "https://roas-calculator.tech/image-compressor/comprehensive-guide",
  },
      twitter: {
  ...
  alternates: {
    canonical: "https://roas-calculator.tech/image-compressor/comprehensive-guide",
  },
};
      ...
      <main className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-12">
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-8 md:p-12 text-white">
          ...
          <p className="text-slate-400 text-sm mt-6">
             Read Time: 12 minutes |  Sections: 15 | OK Expert Verified
          </p>
        </div>
        ...
        <article className="p-8 md:p-12 prose lg:prose-lg max-w-none text-slate-700 space-y-8">
          ...
          <section id="formats">
            ...
            <div className="grid md:grid-cols-2 gap-4 bg-slate-50 p-6 rounded-lg mb-4">
              <div>
                <p className="font-bold text-slate-900 text-green-600">OK Pros</p>
              ...
              <div>
                <p className="font-bold text-slate-900 text-red-600">X Cons</p>
                <ul className="text-sm space-y-1 text-slate-700">
              ...
              <table className="w-full border border-slate-300 text-sm">
                ...
                <tbody>
                  <tr className="bg-white">
                    ...
                    <td className="border border-slate-300 px-4 py-2">X No</td>
                    <td className="border border-slate-300 px-4 py-2">OK 100%</td>
                    <td className="border border-slate-300 px-4 py-2">OK Yes</td>
                  </tr>
                  <tr className="bg-slate-50">
                    ...
                    <td className="border border-slate-300 px-4 py-2">OK Yes</td>
                    <td className="border border-slate-300 px-4 py-2">OK 100%</td>
                    <td className="border border-slate-300 px-4 py-2">! Sometimes</td>
                  </tr>
                  <tr className="bg-white">
                    ...
                    <td className="border border-slate-300 px-4 py-2">OK Yes</td>
                    <td className="border border-slate-300 px-4 py-2">OK 95%</td>
                    <td className="border border-slate-300 px-4 py-2">X No</td>
                  </tr>
                  <tr className="bg-slate-50">
          ...
          <section id="algorithms">
            ...
            <ol className="list-decimal pl-5 space-y-3">
              <li>
                <strong>Divide:</strong> The image is divided into 8x8 pixel blocks (64 pixels per block).
              </li>
              <li>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-600 p-6 rounded mt-4">
              <p className="font-bold text-orange-900">! Important Note:</p>
          ...
          <section id="storage">
            ...
            <div className="grid md:grid-cols-2 gap-6 my-6">
              <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                ...
                <ul className="text-sm space-y-2 text-green-800">
                  <li>- Reduces pixel dimensions (e.g., 4000x3000 to 1000x750)</li>
            ...
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              ...
              <ul className="space-y-2 text-slate-700">
                <li>- <strong>Dimensions:</strong> 4032 x 3024 pixels (12.2 megapixels)</li>
                ...
                <li>- <strong>If resized to 800x600 + compression (quality 40):</strong> ~50 KB</li>
              </ul>
          ...
          <section id="exam-requirements">
              ...
              <table className="w-full border border-slate-300">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-slate-300 px-4 py-2">200x250 recommended</td>
                  </tr>
                  <tr className="bg-slate-50">
                    ...
                    <td className="border border-slate-300 px-4 py-2">3.5x4.5 cm @ 300 DPI</td>
                  </tr>
                  <tr>
                  ...
                  <tr className="bg-slate-50">
                    ...
                    <td className="border border-slate-300 px-4 py-2">10-20 KB</td>
                    <td className="border border-slate-300 px-4 py-2">JPG</td>
                    <td className="border border-slate-300 px-4 py-2">250x300 recommended</td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-slate-300 px-4 py-2">JPG</td>
                    <td className="border border-slate-300 px-4 py-2">3.5x4.5 cm</td>
                  </tr>
                  <tr className="bg-slate-50">
                    ...
                    <td className="border border-slate-300 px-4 py-2">JPG</td>
                    <td className="border border-slate-300 px-4 py-2">480x600 min</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-red-50 border-l-4 border-red-600 p-6 rounded mt-6">
              <p className="font-bold text-red-900 mb-2">! Critical Warning:</p>
          ...
          <section id="step-by-step">
            ...
            <ul className="space-y-2 mt-3">
              ...
              <li>
                <strong>Resize:</strong> If the image is 4000x3000 pixels but you only need 200x250, resize first. This dramatically reduces final file size.
              </li>
              <li>
            ...
            <ol className="list-decimal pl-5 space-y-3 mt-3">
              <li>Right-click the downloaded file &rarr; Properties (Windows) or Get Info (Mac)</li>
            ...
            <p className="mt-3 text-sm text-slate-600 italic">
              ! <strong>Critical:</strong> Don't upload your compressed photo on the final day. Test upload 1-2 days before the deadline to ensure:
            </p>
          ...
          <section id="quality">
            ...
            <div className="space-y-4 mt-6">
              <div className="border border-green-300 bg-green-50 p-6 rounded-lg">
                <h4 className="font-bold text-green-900 mb-2">OK Target Size: 50-100 KB</h4>
                <p className="text-green-800 text-sm">Quality: EXCELLENT (barely noticeable compression artifacts)</p>
                <p className="text-green-700 text-sm mt-2">- Perfect for high-resolution photos (3000x2000+ pixels)</p>
              ...
              <div className="border border-blue-300 bg-blue-50 p-6 rounded-lg">
                <h4 className="font-bold text-blue-900 mb-2">OK Target Size: 20-50 KB</h4>
              ...
              <div className="border border-orange-300 bg-orange-50 p-6 rounded-lg">
                <h4 className="font-bold text-orange-900 mb-2">! Target Size: 10-20 KB</h4>
                <p className="text-orange-800 text-sm">Quality: FAIR (visible blocky 8x8 pixel squares)</p>
              ...
              <div className="border border-red-300 bg-red-50 p-6 rounded-lg">
                <h4 className="font-bold text-red-900 mb-2">X Target Size: 1-10 KB</h4>
