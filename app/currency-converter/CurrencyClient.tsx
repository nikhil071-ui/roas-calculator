...
export default function CurrencyClient() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100 max-w-3xl mx-auto my-8">
        ...
        <div className="grid md:grid-cols-[1fr_auto_1fr] gap-6 items-end mb-8">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              onFocus={(e) => e.target.select()} // <--- THE MAGIC FIX: Auto-selects text on click
              placeholder="0.00"
